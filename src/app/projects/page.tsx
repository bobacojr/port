        ...
        <AnimatePresence mode="wait">
            <motion.div
                ...
                <div className="flex flex-col w-full h-full items-center justify-center">
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            <h1 className='flex justify-center items-center thernaly tracking-widest text-sm sm:text-xl'>
                                Producer/Consumer CPU Simulation
                            </h1>
                            <div className='flex flex-row'>
                                <img src={"./prodcon.png"} className="sm:w-[33em] sm:h-[16em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center mr-3 ml-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            <h1 className='flex justify-center items-center thernaly tracking-widest text-sm sm:text-xl'>
                                Tortilleria Y Taqueria Mi Tierra
                            </h1>
                            <div className='flex flex-row'>
                                <img src={"./TortilleriaPhoto.png"} className="sm:w-[33em] sm:h-[16em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./ThreeJS.png"} className="sm:w-[33em] sm:h-[16em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center mr-3 ml-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./chess.png"} className="sm:w-[33em] sm:h-[16em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./Doom.png"} className="sm:h-[16em] sm:w-[33em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            <h1 className='flex justify-center items-center thernaly tracking-wider text-sm sm:text-xl'>
                                Python/Pygame Jumping Knight Game
                            </h1>
                            <div className='flex flex-row'>
                                <img src={"./dungeon.png"} className="sm:h-[16em] sm:w-[33em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6'>
                        <motion.div className="flex flex-col w-full sm:w-[33em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./savingchristmas.png"} className="sm:h-[16em] sm:w-[33em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
