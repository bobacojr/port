        ...
        <AnimatePresence mode="wait">
            <motion.div
                ...
                <div className="flex flex-col w-full h-full items-center justify-center">
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./prodcon.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%] mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center mr-3 ml-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            <h1 className='flex justify-center items-center thernaly tracking-widest text-sm sm:text-xl'>
                                Tortilleria Y Taqueria Mi Tierra
                            </h1>
                            <div className='flex flex-row'>
                                <img src={"./TortilleriaPhoto.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%]  mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./ThreeJS.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%]  mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center mr-3 ml-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./chess.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%]  mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./Doom.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%]  mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./dungeon.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%]  mb-10 mt-3 lg:ml-3 lg:mt-10'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3 mr-3 lg:mb-6 xl:ml-16 xl:mr-16'>
                        <motion.div className="flex flex-col w-full sm:w-[28em]">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./savingchristmas.png"} className="sm:w-[28em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] lg:w-[40%]  mb-10 mt-3 lg:ml-3 lg:mt-10'>
