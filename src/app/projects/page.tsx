        ...
        <AnimatePresence mode="wait">
            ...
            >
                ...
                <div className="flex flex-col w-full h-full items-center justify-center">
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            <h1 className='flex justify-center w-[33em] items-center thernaly tracking-widest text-sm sm:text-xl border-2 border-red-600'>
                                Producer/Consumer CPU Simulation
                            </h1>
                            <div className='flex flex-row'>
                                <img src={"./prodcon.png"} className="w-[90%] sm:w-[33em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./TortilleriaPhoto.png"} className="w-[90%] sm:w-[36em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./ThreeJS.png"} className="w-[90%] sm:w-[36em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./chess.png"} className="w-[90%] sm:w-[36em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./Doom.png"} className="w-[90%] sm:w-[36em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./dungeon.png"} className="w-[90%] sm:w-[36em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center ml-3'>
                        <motion.div className="flex flex-col w-full">
                            ...
                            <div className='flex flex-row'>
                                <img src={"./savingchristmas.png"} className="w-[90%] sm:w-[36em] border-2 border-mygray rounded-[30px]"/>
                            </div>
                        </motion.div>
                        <p className='w-[90%] mb-10 mt-3'>
